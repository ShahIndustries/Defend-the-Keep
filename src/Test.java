...
public class Test extends JPanel implements ActionListener, KeyListener
{
    ...
    //private final static int ROCKET_WIDTH = 700;
    //private final static int ROCKET_HEIGHT = 600;
    ...
    private int rocketX = (Main.FRAME_WIDTH);
    private int rocketY = (Main.FRAME_HEIGHT);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else
        {
           ...
           // if ((ballX >= (MainGame.FRAME_WIDTH - BALL_WIDTH)) || (ballX <= 0))
           // {
           ...
           // if ((ballY >= (MainGame.FRAME_HEIGHT - MainGame.TITLE_HEIGHT - BALL_HEIGHT)) || (ballY <= 0))
           // {
